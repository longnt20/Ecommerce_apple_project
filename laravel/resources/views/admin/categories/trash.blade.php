            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">Danh sách danh mục đã xóa</li>
                    </ol>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1">
                                                    <div class="edit">
                                                        <form action="{{ route('admin.categories.restore', $item->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('PATCH')
                                                    ...
                                                    <div class="remove">
                                                        <form method="POST"
                                                            action="{{ route('admin.categories.force-delete', $item->id) }}"
